...
import { j as getSubjects, i as getModulesForSubject } from '../chunks/service_DAF_8fqT.mjs';
export { renderers } from '../renderers.mjs';

const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  const sortedSubjects = await getSubjects();
  const subjectsWithLinks = (await Promise.all(sortedSubjects.map(async (subject) => {
...
</h1> <!-- Subjects Container with exact structure --> <div id="subjects-container"> ${uniqueCategories.map((category) => {
